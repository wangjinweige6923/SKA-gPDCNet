...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run train.py through the backbone-aware wrapper without modifying the original file."
    )
    parser.add_argument(
        "--backbone",
        default="resnet50",
...
def main():
    ...
    # Alias the original torch_utils import so train.py can stay unchanged.
    ...
    try:
        ...
        baseline_train = importlib.import_module("train")
        baseline_train.main()
    finally:
        sys.argv = old_argv
